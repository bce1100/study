...
public class ComperhensivePractice {
    ...
    public static void main(String[] args) {
        ...
        *//*for (Transaction t : trx2011) {
        ...
        // transactions.stream().map(Transaction::getTrader).map(Trader::getName).distinct().sorted().reduce(String::concat).ifPresent(System.out::println);
        /*transactions.stream()
                .map(Transaction::getTrader)
                .map(Trader::getName)
                .distinct()
